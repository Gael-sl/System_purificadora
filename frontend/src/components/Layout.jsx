...
import { LayoutDashboard, ShoppingCart, Map, Users, Package, DollarSign, LogOut, Wallet, Menu, X, Settings } from 'lucide-react';
          ...
          <div className="mb-3 px-4 flex items-center justify-between gap-2">
            ...
            {user.rol === 'admin' && (
              <button 
                ...
                className="pl-3 pr-3 py-2 text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors shadow-sm flex items-center gap-2"
